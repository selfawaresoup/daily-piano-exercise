require 'fileutils'
files = Dir["export/exercises_scores - Full Score - ??.svg"]
...
files.each_with_index do |filename, index|
  ...
  FileUtils.mkdir_p 'notation'
  File.write "../src/resources/notation/#{target_name}.svg", formatted_svg unless target_name.nil?
end
