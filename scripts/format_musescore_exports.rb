#!/usr/bin/env ruby
Dir.chdir "./public/notation"
files = Dir["exercises_scores - Full Score - ??.svg"]
...
svg_line = '<svg width="1000px" height="300px" viewBox="0 400 3040 900" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.2" baseProfile="tiny">'
...
files.each_with_index do |filename, index|
  ...
  File.write "#{target_names[index]}.svg", formatted_svg
